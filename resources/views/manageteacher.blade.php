...
<nav class="navbar navbar-expand bg-dark navbar-dark" id="nav1">
    <div class="container-fluid">
        <ul class="navbar-nav">
            ...
            <!-- <li class="nav-item" id="hm">
                <a class="nav-link mr-3 active" href="{{url('/managestudentadmission')}}">ManageStudentAdmission</a>
            </li> -->
            <li class="nav-item" id="hm">
...
<div class="container">
     <h1 class="mt-3 text-center">Users of Student CRUD System.</h1>
      <div class="col-lg-12">
	   <h1 style="background-color:lightgrey" align="center"> Teacher detail</h1>
</div>

    
        
        <div class="container">
            <h1 class="mt-3 text-center">Teacher Detail.</h1>
        </div>
        <br><br>
        <div class="container">
            <?php
        ...
        $crud = \DB::table('user1')->where('Role', 'teacher')->get();
        ?>
        <div class="container">
